...
public static class DiffusionPromptComposer
{
    ...
    [
        ...
        new(["metal", "iron", "steel", "bronze", "brass", "chain", "grate", "anvil"], "burnished painted metal, worn bright edges"),
        new(["roof", "shingle", "thatch", "slate"], "painted rooftop shingles, layered rows"),
        new(["cloth", "banner", "flag", "rug", "carpet", "tapestry", "curtain", "tent", "sail"], "painted woven cloth, soft fabric folds"),
