...
- **Spell effects** is a separate preview-first scope for supported loose single-image art in the client's effect directories. Animation sheets, flipbooks, strips, technical maps, unsupported aspect ratios/containers, fully transparent controls, and ambiguous resources remain original. Soft translucent alpha always uses Original Clarity regardless of the selected style.
...
- **Redo** — rerun only that member with Original Clarity, Texture HD, Material Detail, or Illustrated / Clean Painted.
